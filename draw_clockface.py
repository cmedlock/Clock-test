...
for fname in dirs:
    ...
    xy_copy.set_xlabel(r'$x$',fontsize=x_axis_fontsize)

    y_axis_fontsize = 20
    xt_copy.set_ylabel(r'$x$',fontsize=y_axis_fontsize)
    yt_copy.set_ylabel(r'$y$',fontsize=y_axis_fontsize)
    xy_copy.set_ylabel(r'$y$',fontsize=y_axis_fontsize)
    ...
    xy_command.set_xlabel(r'$x$',fontsize=x_axis_fontsize)

    xt_command.set_ylabel(r'$x$',fontsize=y_axis_fontsize)
    yt_command.set_ylabel(r'$y$',fontsize=y_axis_fontsize)
    xy_command.set_ylabel(r'$y$',fontsize=y_axis_fontsize)
