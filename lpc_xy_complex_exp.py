...
#    fig.savefig(path+'figs_raw/'+fname[:len(fname)-4]+'/complex_lpc_x_'+clock_type+'_'+fname[:len(fname)-4]+'.png')
#
#    ax_lin.clear()
#    ax_lpe.clear()
#    # predict y[n]
...
#    fig.savefig(path+'figs_raw/'+fname[:len(fname)-4]+'/complex_lpc_y_'+clock_type+'_'+fname[:len(fname)-4]+'.png')
#    
#    # the whole clock
#    fig2 = plt.figure()
...
#    fig2.savefig(path+'figs_raw/'+fname[:len(fname)-4]+'/complex_lpc_wholeClock_'+clock_type+'_'+fname[:len(fname)-4]+'.png')
